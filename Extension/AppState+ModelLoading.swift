...
extension AppState {
        ...
        for pin in pins {
            taskGroup.addTask {
                do {
                    ...
                    debugPrint("pin.prefecture rawValue: \(pin.prefecture.rawValue)")
                    debugPrint("pin prefecture kanji \(pin.prefecture.kanji)")
    ...
    private func addMapEntityToState(entity: Entity) {
        debugPrint("add map entity to state fired")
        mapModel = entity
    }
